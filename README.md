...
| ![](Assets/Animals.jpg)**Fig.1 Classification of Animals** | ![](Assets/Sites.jpg)**Fig.2 Site Source of Images** |
| :--------------------------------------------------------: | :--------------------------------------------------: |

**Data Visualization**

| ![](Assets/leopard.jpg)**Fig.3 Displaying Images of Leopard** | ![](Assets/monkey.jpg)**Fig.4 Displaying Images of Monkey_Prosimian** |
| :-----------------------------------------------------------: | :-------------------------------------------------------------------: |
...
1. EfficientNetB4
1. EfficientNetV2_S
1. Ensemble (EfficientNetB4 L1L2 + EfficientNetV2_S) - **Final Model**
...
|                      ResNet50 - **Baseline**                      | Ensemble (EfficientNetB4 L1L2 + EfficientNetV2_S) - **Final Model** |
| :---------------------------------------------------------------: | :-----------------------------------------------------------------: |
| ![](Assets/resnet50tvl.png)**Fig.7 Training and validation loss** |    ![](Assets/eb4tvl.png)**Fig.8 Training and validation loss**     |
|           ![](Assets/resnet50ll.png)**Fig.9 Log Loss**            |       <p>![](Assets/eb4ll.png)</p><p>**Fig.10 Log Loss**</p>        |
